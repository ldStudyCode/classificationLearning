...
public class MyReentrantLock {
    ...
    public boolean hasWaiters(Condition condition) {
        ...
        if (!(condition instanceof MyAQS.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.hasWaiters((MyAQS.ConditionObject)condition);
    }
    ...
    public int getWaitQueueLength(Condition condition) {
        ...
        if (!(condition instanceof MyAQS.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitQueueLength((MyAQS.ConditionObject)condition);
    }
    ...
    protected Collection<Thread> getWaitingThreads(Condition condition) {
        ...
        if (!(condition instanceof MyAQS.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitingThreads((MyAQS.ConditionObject)condition);
    }
