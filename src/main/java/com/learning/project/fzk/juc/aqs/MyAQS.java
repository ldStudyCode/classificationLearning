 ...
 * AQS同步器源码阅读、注释翻译等
 *
 * 使用了模板方法模式，tryAcquire等方法需要由子类实现
 * 
...
public class MyAQS extends AbstractOwnableSynchronizer {
    ...
    /**
     * 多种acquire方法，区别在于共享/排他，以及不同的控制模式。
     * 每个方法大体相同，但由于异常机制和其他控制的相互作用下，只有一小部分可以在不影响性能的情况下被拆分出来。
     */
     ...
     * MyAQS} serving as the basis of a {@link
     * Lock} implementation.
     *
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
         ...
         * Implements {@link MyAQS#hasWaiters(ConditionObject)}.
         *
         * @return {@code true} if there are any waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *         returns {@code false}
         ...
         * this condition.
         * Implements {@link MyAQS#getWaitQueueLength(ConditionObject)}.
         *
         * @return the estimated number of waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *         returns {@code false}
         ...
         * Implements {@link MyAQS#getWaitingThreads(ConditionObject)}.
         *
         * @return the collection of threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *         returns {@code false}
